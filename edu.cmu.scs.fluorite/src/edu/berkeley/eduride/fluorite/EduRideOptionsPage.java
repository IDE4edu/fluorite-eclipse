...
public class EduRideOptionsPage extends PreferencePage implements
	...
	public EduRideOptionsPage() {
	}

	public EduRideOptionsPage(String title) {
		super(title);
	}

	public EduRideOptionsPage(String title, ImageDescriptor image) {
		super(title, image);
	}
